...
/*
HPACK tables (RFC 7541).

The Huffman code and the static table are fixed by the specification and are
reproduced here verbatim. The Huffman table was cross-checked with a Kraft sum
of exactly 1.0, which any complete canonical code must satisfy.
*/

// Symbol 256 is EOS, legal only as trailing padding.
HUFFMAN_EOS :: 256

HUFFMAN_CODE := [257]u32{
...
// Index 0 is unused: HPACK numbers the static entries from 1.
STATIC_TABLE := [62]Header_Field{
	{"", ""},
	{":authority", ""},
	{":method", "GET"},
	{":method", "POST"},
